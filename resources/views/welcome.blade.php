        ...
        <div class="modal-body">
          ...
          <form class="reg__group needs-validation" id="user-data" novalidate>
            ...
            <div class="file-upload__group input__group" required>
              <input type="file" class="file-upload__label file-upload__in  form-control"
                onchange="return fileValidation()" name="check" aria-label="file example" required>
              <label for="checkLoad" class="reg-label reg-label--check" id="checkLoadLabel">Загрузите пожалуйста чек
                (внимание, чек должен быть читабельным)<br></label>
              <div class="invalid-feedback" id="file-info">Извините, но без чека вы не можете принять участие в акции
              </div>
            </div>
